  ...
  return (
    <div className="max-w-2xl mx-auto my-[10vh]">
      ...
      <p className="mx-4 mb-4 text-center max-w-[40ch]:">
        Welcome to our GWA Calculator, Ga! This tool is designed for students in the
        University of Mindanao to calculate their General Weighted Average
        (GWA). Just input your grades, and let the calculator do the rest! 🤗
      </p>
      <motion.div
